...
function convert(subtitleText, inputExtension, outputExtension, options) {
  ...
  // overwriting inputExtension if it does not match actual file content(dfxp will be ttml)
  const extractedExtension = getExtension(subtitleText);
  if (extractedExtension !== inputExtension) inputExtension = extractedExtension;
