...
module.exports = {
  ...
  /**
     ...
     */
  translateLine: function translateLine(SCCLine) {
    if (SCCLine.length === 0) {
      return;
    }
  ...
  /**
     ...
     */
  translateTime: function translateTime(stampTime) {
    var secondsPerStamp = 1.001;
    var timesplit = stampTime.split(':');
    var timestampSeconds = parseInt(timesplit[0], 10) * 3600 + parseInt(timesplit[1], 10) * 60 + parseInt(timesplit[2], 10) + parseInt(timesplit[3], 10) / 30;
    var seconds = timestampSeconds * secondsPerStamp;
